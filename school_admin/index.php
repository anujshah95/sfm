...
<div class= "col-md-9">
	<h2><dt>Introduction :</dt></h2>
	<h4><dl>
    	<dd> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; The owner of <b> <?php echo $cname;?></b> is <b><?php echo $hname;?></b>. The Center Code of <b><?php echo $cname;?></b> is <b><?php echo $code;?></b>. The onwer has rights to sell his franchisee on its own rules. The total number of branches uptill now is <b><?php echo $tot;?></b>, out of which the active schools are <b><?php echo $active;?></b> and inactive schools are <b><?php echo $inactive;?></b> </dd>
