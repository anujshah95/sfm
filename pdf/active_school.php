...
// add a page
	...
	//$pdf->writeHTML($hea, true, 0, true, 0);
		...
		$query1=mysql_query("select * from `company`");
$pdf->AddPage();
	$pdf->SetFont('helvetica', '', 10);

	
	$pkt11='<html><head><title>Active Schools Report</title></head><center><h1>Active Schools</h1></center>
	<table border="1"  cellpadding="5"  cellspcing="5" ><tr><th>Sn</th><th>Company Name</th><th>Location</th><th>Code</th><th>Head Name</th><th>Phone Number</th><th>Email Id</th></tr>';
